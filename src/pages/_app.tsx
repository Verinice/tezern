    ...
    <Fragment>
      <Head>
        ...
        <meta
          ...
          content="Be a DeFi Chef with Sushi. Swap, earn, stack yields, lend, borrow, leverage all on one decentralized, community driven platform. Welcome home to DeFi"
        />
        <meta key="twitter:image" name="twitter:image" content="/icons/icon-192x192.png" />
        ...
        <meta key="og:image" property="og:image" content="/icons/icon-192x192.png" />
        <meta
          key="og:description"
