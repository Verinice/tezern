...
export default function Farm(): JSX.Element {
  ...
  return (
    <Container id="farm-page" className="grid h-full grid-cols-4 py-4 mx-auto md:py-8 lg:py-12 gap-9" maxWidth="7xl">
      <Head>
        <title> Tezern | Farm </title>
        <meta key="description" name="description" content="Farm Tezern" />
      </Head>
      ...
      <div className={classNames('space-y-6 col-span-4 lg:col-span-3')}>
        <Search
          ...
          inputProps={{
            className:
              'relative text-blue-200 w-full search border border-transparent focus:border-gradient-r-blue-pink-dark-900 rounded focus:placeholder-primary font-bold text-base px-6 py-3.5',
          }}
        />
