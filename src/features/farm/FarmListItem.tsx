        ...
        <>
          <Disclosure.Button
            className={classNames(
              open && 'rounded-b-none',
              'w-full px-4 py-6 text-left rounded cursor-pointer select-none farm-list text-primary text-sm md:text-lg'
            )}
          >
            <div className="grid grid-cols-4">
              ...
              <div className="flex flex-col justify-center font-bold text-purple">{formatNumber(farm.tvl, true)}</div>
              <div className="flex-row items-center hidden space-x-4 md:flex">
                ...
                <div className="flex flex-col space-y-1">
                  {farm?.rewards?.map((reward, i) => (
                    <div key={i} className="text-xs text-purple md:text-sm whitespace-nowrap">
              ...
              <div className="flex flex-col items-end justify-center">
                <div className="font-bold text-purple text-righttext-high-emphesis">
